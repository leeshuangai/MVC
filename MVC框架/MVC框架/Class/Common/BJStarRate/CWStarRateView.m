...
#define FOREGROUND_STAR_IMAGE_NAME @"icon_star"
#define BACKGROUND_STAR_IMAGE_NAME @"icon_nostar"
...
- (instancetype)initWithFrame:(CGRect)frame {
    return [self initWithFrame:frame numberOfStars:DEFALUT_STAR_NUMBER noStar:NO];
}

- (instancetype)initWithCoder:(NSCoder *)aDecoder {
    if (self = [super initWithCoder:aDecoder]) {
        _numberOfStars = DEFALUT_STAR_NUMBER;
        [self buildDataAndUINoStar:NO];
    }
    return self;
}

- (instancetype)initWithFrame:(CGRect)frame numberOfStars:(NSInteger)numberOfStars noStar:(BOOL)isStar {
    if (self = [super initWithFrame:frame]) {
        self.numberOfStars = numberOfStars;
        [self buildDataAndUINoStar:isStar];
    }
    return self;
}
...
- (void)buildDataAndUINoStar:(BOOL)isStar {
    ...
    if (isStar) {
       ...
       self.backgroundStarView = [self createStarViewWithImage:FOREGROUND_STAR_IMAGE_NAME];
    }
...
- (UIView *)createStarViewWithImage:(NSString *)imageName {
    ...
    NSLog(@"createStarViewWithImage == %ld",self.numberOfStars);
